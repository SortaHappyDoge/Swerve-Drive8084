...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void periodic() {
        ...
        LimelightHelpers.SetRobotOrientation("limelight-alfa", this.getState().Pose.getRotation().getDegrees(), 0, 0, 0, 0, 0);
        LimelightHelpers.PoseEstimate mt2 = LimelightHelpers.getBotPoseEstimate_wpiBlue_MegaTag2("limelight-alfa");
        LimelightHelpers.PoseEstimate mt1 = LimelightHelpers.getBotPoseEstimate_wpiBlue("limelight-alfa");
        if(mt2 != null){
    ...
    public Command allign(PathPlannerPath path){
        return AutoBuilder.pathfindThenFollowPath(path, TunerConstants.pathfindingConstraints);
    }
